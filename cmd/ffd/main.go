...
import (
	...
	"github.com/FreeFlixMedia/freeflix-media-hub/app"
	"github.com/FreeFlixMedia/freeflix-media-hub/types"
)
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:               "ffd",
		Short:             "FreeFlix-Hub Daemon (server)",
	...
	executor := cli.PrepareBaseCmd(rootCmd, "FF", app.DefaultNodeHome)
...
func exportAppStateAndTMValidators(
	...
	if height != -1 {
		gapp := app.NewFreeFlixApp(logger, db, traceStore, false, uint(1), map[int64]bool{}, "")
	...
	gapp := app.NewFreeFlixApp(logger, db, traceStore, true, uint(1), map[int64]bool{}, "")
	return gapp.ExportAppStateAndValidators(forZeroHeight, jailWhiteList)
}
